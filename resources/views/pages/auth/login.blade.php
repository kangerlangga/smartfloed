...
<head>
    ...
    <meta name="author" content="Smart Floed">
    ...
    <meta name="keywords" content="Smart Flood Early Detection, Smart Floed">
    <meta name="description" content="Smart Flood Early Detection adalah suatu sistem yang dirancang untuk mendeteksi secara dini potensi banjir dan memberikan peringatan kepada masyarakat sekitar.">
...
<body>
    ...
    <div class="row">
        ...
        <form method="POST" action="{{ route('login.verifikasi') }}" enctype="multipart/form-data">
            ...
            <button class="btn btn-block btn-warning text-white mt-3 pt-2 pb-2 fw-bold" style="font-size: medium;"><b>LOGIN</b></button>
